...
# ppi
python -m graphsage.supervised_train --train_prefix ~/data/ppi/ppi --model mean_add --dim_1 512 --dim_2 512 --samples_1 25 --samples_2 10 --batch_size 512 --validate_batch_size 512 --gpu 0 --sigmoid --fast_ver --epochs 100
